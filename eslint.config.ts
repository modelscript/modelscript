      ...
      parserOptions: {
        projectService: {
          allowDefaultProject: [
            ...
            "packages/diagram/jest.config.ts",
            "packages/diagram/tests/test-dsl-adapter.test.ts",
            "packages/mcp/jest.config.ts",
            "packages/mcp/tests/*.ts",
            "packages/mcp/tests/polyglot-mcp.test.ts",
