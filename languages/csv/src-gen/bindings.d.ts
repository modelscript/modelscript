...
export interface RowNode extends SyntaxNode {
  readonly typeId: SyntaxKind.Row;
}
export declare function isRow(node: SyntaxNode | null | undefined): node is RowNode;
export interface CellNode extends SyntaxNode {
  readonly typeId: SyntaxKind.Cell;
}
export declare function isCell(node: SyntaxNode | null | undefined): node is CellNode;
export interface CSVVirtualComponentNode extends SyntaxNode {
...
export namespace Cst {
  ...
  export const Row: {
    readonly typeId: number;
    readonly type: string;
    is(node: SyntaxNode | null | undefined): node is RowNode;
    cells(node: SyntaxNode | null | undefined): SyntaxNode | null;
    cellsList(node: SyntaxNode | null | undefined): SyntaxNode[];
  };
  export const Cell: {
    readonly typeId: number;
    readonly type: string;
    is(node: SyntaxNode | null | undefined): node is CellNode;
  };
  export const CSVVirtualComponent: {
    readonly typeId: number;
    readonly type: string;
    is(node: SyntaxNode | null | undefined): node is CSVVirtualComponentNode;
  };
}
