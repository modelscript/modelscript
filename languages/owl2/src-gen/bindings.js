...
export const SYNTAX_NAMES =
  typeof [
    ...
    "IDENT",
    "FullIRI",
    "_(FullIRI | AbbreviatedIRI)",
    "StringLiteral",
    "_(IRI | ())",
    "_ImportDeclaration*",
    "__Axiom*",
    "_(Declaration | SubClassOfAxiom | EquivalentClassesAxiom | DisjointClassesAxiom | ObjectPropertyAssertionAxiom | DataPropertyAssertionAxiom | ClassAssertionAxiom | TransitiveObjectPropertyAxiom)",
    "_(ClassEntity | ObjectPropertyEntity | DataPropertyEntity | NamedIndividualEntity)",
    "_(IRI | ObjectIntersectionOf | ObjectUnionOf | ObjectComplementOf | ObjectSomeValuesFrom | ObjectAllValuesFrom | DataSomeValuesFrom | DataAllValuesFrom)",
    "__ClassExpression*",
    "_(IRI)",
    "UNKNOWN",
    "UNKNOWN",
