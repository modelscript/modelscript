...
export const SYNTAX_NAMES =
  typeof [
    ...
    '_(("(" STRING ")") | ())',
    "_EntityInstance*",
    "_(SimpleRecord | ComplexRecord)",
    "_(ParameterList | ())",
    "_SimpleRecord*",
    '_("," _Parameter)*',
    "_(TypedParameter | EntityReference | REAL | INTEGER | STRING | ENUMERATION | ListValue | OMITTED_PARAMETER | DERIVED_PARAMETER)",
    "OMITTED_PARAMETER",
    "DERIVED_PARAMETER",
...
export const FIELD_NAMES =
  typeof { headerEntity: 1, keyword: 2, parameters: 3, scopeName: 4, entity: 5, id: 6, record: 7, target: 8 } !==
  "undefined"
    ? { headerEntity: 1, keyword: 2, parameters: 3, scopeName: 4, entity: 5, id: 6, record: 7, target: 8 }
    : {};
