...
import { ArenaExprVisitor } from "./visitor.js";
...
export class ArenaQueryFlattener {
  ...
  private flattenClassWithMods(
    ...
    for (const child of projectedChildren) {
      if (child.kind === "Component") {
        ...
        const inlineMod = this.db.query<import("./modifications.js").ModelicaModArgs | null>(
  ...
  private getInheritedTypeMod(
    scopeId: SymbolId,
    typeName: string,
  ): import("./modifications.js").ModelicaModArgs | null {
    let mergedTypeMod: import("./modifications.js").ModelicaModArgs | null = null;
    ...
    while (currentClassId && !visited.has(currentClassId)) {
      ...
      if (extendsClause) {
        const extendsMod = this.db.query<import("./modifications.js").ModelicaModArgs | null>(
  ...
  private flattenComponent(
    ...
    if (typeName) {
      let typeOuterMod: import("./modifications.js").ModelicaModArgs | null = null;
      let typeInlineMod: import("./modifications.js").ModelicaModArgs | null = null;
      let typeExtendsMod: import("./modifications.js").ModelicaModArgs | null = null;
      ...
      if (!typeName.includes(".")) {
        ...
        if (entry.parentId !== null) {
          ...
          if (resolveName) {
            ...
            if (typeEntry) {
              typeInlineMod = this.db.query<import("./modifications.js").ModelicaModArgs | null>(
                "effectiveModification",
                typeEntry.id,
              );
            }
    ...
    let typeMods: import("./modifications.js").ModelicaModArgs | null = null;
    ...
    if (!isPredefined) {
      while (currentClassId && !visitedBase.has(currentClassId)) {
        ...
        const classInlineMod = this.db.query<import("./modifications.js").ModelicaModArgs | null>(
          "effectiveModification",
          currentClassId,
        );
  ...
  private flattenArrayComponent(
    ...
    let elementMod: import("./modifications.js").ModelicaModArgs | null = effectiveMod
...
export { ArenaQueryFlattener as ModelicaFlattener };

import type { ChunkedUint32Array } from "@modelscript/language";
