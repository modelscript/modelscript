...
//
// [OpenModelica/flattening/modelica/arrays/ArrayDivError.mo:11:3-11:23:writable] Error: Type mismatch in equation {{Div1[1,1], Div1[1,2], Div1[1,3]}}={1.0, 2.0, 3.0} of type Real[1, 3]=Real[3].
