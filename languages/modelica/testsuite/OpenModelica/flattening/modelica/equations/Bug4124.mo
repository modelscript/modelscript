...
//   final parameter Integer unpackInt.nu(min = 0, max = 1) = 1 "Output connector size";
...
//   final parameter Integer unpackInt1.nu(min = 0, max = 1) = 0 "Output connector size";
...
//   when initial() then
//     unpackInt.pkgIn.autoPkgBitSize = unpackInt.pkgOut[1].autoPkgBitSize + unpackInt.bitOffset + unpackInt.width;
//   end when;
...
//   when initial() then
//     unpackInt1.pkgIn.autoPkgBitSize = unpackInt1.bitOffset + unpackInt1.width;
//   end when;
