...
export const SYNTAX_NAMES =
  typeof ["ERROR","/\\s/","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","\"within\"","\";\"","\"redeclare\"","\"final\"","\"inner\"","\"outer\"","\"replaceable\"","\"encapsulated\"","\"partial\"","\"class\"","\"model\"","\"operator\"","\"record\"","\"block\"","\"expandable\"","\"connector\"","\"type\"","\"package\"","\"pure\"","\"impure\"","\"function\"","\"optimization\"","\"shape\"","\"field\"","\"process\"","\"extends\"","\"end\"","\"=\"","\"input\"","\"output\"","\"enumeration\"","\"(\"","\",\"","\":\"","\")\"","\"der\"","\"external\"","\"protected\"","\"public\"","\"import\"","\".\"","\"{\"","\"}\"","\"*\"","\"constrainedby\"","\"break\"","\"flow\"","\"stream\"","\"discrete\"","\"parameter\"","\"constant\"","\"if\"","\"each\"","\"initial\"","\"equation\"","\"algorithm\"","\"constraint\"","\":=\"","\"<=\"","\">=\"","\"<\"","\">\"","\"return\"","\"then\"","\"else\"","\"elseif\"","\"for\"","\"loop\"","\"in\"","\"while\"","\"when\"","\"elsewhen\"","\"connect\"","\"not\"","\"+\"","\"-\"","\".+\"","\".-\"","\"or\"","\"and\"","\"==\"","\"<>\"","\"/\"","\".*\"","\"./\"","\"^\"","\".^\"","\"[\"","\"]\"","\"annotation\"","\"false\"","\"true\"","/([_a-zA-Z\\u00C0-\\u024F\\u0370-\\u03FF\\u0400-\\u04FF\\u0500-\\u052F\\u0600-\\u06FF\\u0750-\\u077F\\u08A0-\\u08FF\\u0900-\\u097F\\u0980-\\u09FF\\u0A00-\\u0A7F\\u0A80-\\u0AFF\\u0B00-\\u0B7F\\u0B80-\\u0BFF\\u0C00-\\u0C7F\\u0C80-\\u0CFF\\u0D00-\\u0D7F\\u0E00-\\u0E7F\\u0E80-\\u0EFF\\u1000-\\u109F\\u1100-\\u11FF\\u3040-\\u309F\\u30A0-\\u30FF\\u3400-\\u4DBF\\u4E00-\\u9FFF\\uAC00-\\uD7AF\\uFB50-\\uFDFF\\uFE70-\\uFEFF][_a-zA-Z0-9\\u00C0-\\u024F\\u0370-\\u03FF\\u0400-\\u04FF\\u0500-\\u052F\\u0600-\\u06FF\\u0750-\\u077F\\u08A0-\\u08FF\\u0900-\\u097F\\u0980-\\u09FF\\u0A00-\\u0A7F\\u0A80-\\u0AFF\\u0B00-\\u0B7F\\u0B80-\\u0BFF\\u0C00-\\u0C7F\\u0C80-\\u0CFF\\u0D00-\\u0D7F\\u0E00-\\u0E7F\\u0E80-\\u0EFF\\u1000-\\u109F\\u1100-\\u11FF\\u3040-\\u309F\\u30A0-\\u30FF\\u3400-\\u4DBF\\u4E00-\\u9FFF\\uAC00-\\uD7AF\\uFB50-\\uFDFF\\uFE70-\\uFEFF]*|'([^'\\\\]|\\\\.)*')/","/\"([^\"\\\\]|\\\\['\"?\\\\abfnrtv])*\"/","/[0-9]+/","/([0-9]+\\.[0-9]*|[0-9]*\\.[0-9]+)([eE][+-]?[0-9]+)?|[0-9]+[eE][+-]?[0-9]+/","/\\/\\*[^*]*\\*+([^/*][^*]*\\*+)*\\//","/\\/\\/[^\\r\\n]*/","/\\u00EF\\u00BB\\u00BF/","StoredDefinition","WithinDirective","ClassDefinition","ClassPrefixes","_ClassSpecifier","LongClassSpecifier","ShortClassSpecifier","DerClassSpecifier","EnumerationLiteral","ExternalFunctionClause","LanguageSpecification","ExternalFunctionCall","InitialElementSection","ElementSection","_Element","ElementAnnotation","_ImportClause","SimpleImportClause","CompoundImportClause","UnqualifiedImportClause","ExtendsClause","ConstrainingClause","ClassOrInheritanceModification","InheritanceModification","ComponentClause","ComponentDeclaration","ConditionAttribute","Declaration","Modification","ModificationExpression","ClassModification","_ModificationArgument","ElementModification","ElementRedeclaration","ComponentClause1","ComponentDeclaration1","ShortClassDefinition","EquationSection","AlgorithmSection","ConstraintSection","_Equation","_Statement","SimpleAssignmentStatement","ProcedureCallStatement","ComplexAssignmentStatement","SimpleEquation","SpecialEquation","BreakStatement","ReturnStatement","IfEquation","ElseIfEquationClause","IfStatement","ElseIfStatementClause","ForEquation","ForStatement","ForIndex","WhileStatement","WhenEquation","ElseWhenEquationClause","WhenStatement","ElseWhenStatementClause","ConnectEquation","_Expression","IfElseExpression","ElseIfExpressionClause","RangeExpression","_SimpleExpression","UnaryExpression","BinaryExpression","_PrimaryExpression","_Literal","TypeSpecifier","Name","ComponentReference","ComponentReferencePart","FunctionCall","FunctionCallArguments","ArrayConcatenation","ArrayConstructor","ComprehensionClause","NamedArgument","FunctionArgument","FunctionPartialApplication","MemberAccessExpression","OutputExpressionList","ExpressionList","ArraySubscripts","Subscript","Description","AnnotationClause","BOOLEAN","_START","_(BOM | ())","_(WithinDirective | ())","_(ClassDefinition | ComponentClause | _Statement)","_(ClassDefinition | ComponentClause | _Statement)*","_(Name | ())","_(\"redeclare\" | ())","_(\"final\" | ())","_(\"inner\" | ())","_(\"outer\" | ())","_(\"replaceable\" | ())","_(\"encapsulated\" | ())","_(ConstrainingClause | ())","_(\"partial\" | ())","_(\"class\" | \"model\" | ((\"operator\" | ()) \"record\") | \"block\" | ((\"expandable\" | ()) \"connector\") | \"type\" | \"package\" | (((\"pure\" | \"impure\") | ()) (\"operator\" | ()) \"function\") | \"operator\" | \"optimization\" | \"shape\" | \"field\" | \"process\")","_(\"operator\" | ())","_(\"expandable\" | ())","_(\"pure\" | \"impure\")","_((\"pure\" | \"impure\") | ())","_(LongClassSpecifier | ShortClassSpecifier | DerClassSpecifier)","_(\"extends\" | ())","_(ClassModification | ())","_(Description | ())","_(InitialElementSection | ())","_(ElementSection | EquationSection | AlgorithmSection | ConstraintSection)","_(ElementSection | EquationSection | AlgorithmSection | ConstraintSection)*","_(ExternalFunctionClause | ())","_((AnnotationClause \";\") | ())","_(\"input\" | \"output\")","_((\"input\" | \"output\") | ())","_(ArraySubscripts | ())","_((((\"input\" | \"output\") | ()) TypeSpecifier (ArraySubscripts | ()) (ClassModification | ())) | (\"enumeration\" \"(\" (((EnumerationLiteral (\",\" EnumerationLiteral)*) | \":\") | ()) \")\"))","_(\",\" EnumerationLiteral)*","_((EnumerationLiteral (\",\" EnumerationLiteral)*) | \":\")","_(((EnumerationLiteral (\",\" EnumerationLiteral)*) | \":\") | ())","_(AnnotationClause | ())","_(\",\" IDENT)*","_(LanguageSpecification | ())","_(ExternalFunctionCall | ())","_((ComponentReference \"=\") | ())","_(ExpressionList | ())","__Element*","_(\"protected\" | \"public\")","_(ClassDefinition | ComponentClause | ExtendsClause | _ImportClause | ElementAnnotation)","_(AnnotationClause \";\")","_(SimpleImportClause | CompoundImportClause | UnqualifiedImportClause)","_((IDENT \"=\") | ())","_(ClassOrInheritanceModification | ())","_(_ModificationArgument | InheritanceModification)","_(\",\" (_ModificationArgument | InheritanceModification))*","_(((_ModificationArgument | InheritanceModification) (\",\" (_ModificationArgument | InheritanceModification))*) | ())","_(ConnectEquation | IDENT)","_(\"flow\" | \"stream\")","_((\"flow\" | \"stream\") | ())","_(\"discrete\" | \"parameter\" | \"constant\")","_((\"discrete\" | \"parameter\" | \"constant\") | ())","_(\",\" ComponentDeclaration)*","_(ConditionAttribute | ())","_(Modification | ())","_((\"=\" ModificationExpression) | ())","_((ClassModification ((\"=\" ModificationExpression) | ())) | (\"=\" ModificationExpression))","_(_Expression | \"break\")","_(\",\" _ModificationArgument)*","_((_ModificationArgument (\",\" _ModificationArgument)*) | ())","_(ElementModification | ElementRedeclaration)","_(\"each\" | ())","_(ShortClassDefinition | ComponentClause1)","_(\"initial\" | ())","__Equation*","__Statement*","_(SimpleEquation | SpecialEquation | IfEquation | ForEquation | ConnectEquation | WhenEquation)","_(SimpleAssignmentStatement | ProcedureCallStatement | ComplexAssignmentStatement | BreakStatement | ReturnStatement | IfStatement | ForStatement | WhileStatement | WhenStatement)","_(\":=\" | \"=\")","_(\"=\" | \"<=\" | \">=\" | \"<\" | \">\")","_ElseIfEquationClause*","_((\"else\" _Equation*) | ())","_ElseIfStatementClause*","_((\"else\" _Statement*) | ())","_(\",\" ForIndex)*","_((\"in\" _Expression) | ())","_ElseWhenEquationClause*","_ElseWhenStatementClause*","_(IfElseExpression | RangeExpression | _SimpleExpression)","_ElseIfExpressionClause*","_((_SimpleExpression \":\" _SimpleExpression \":\" _SimpleExpression) | (_SimpleExpression \":\" _SimpleExpression))","_(UnaryExpression | BinaryExpression | _PrimaryExpression)","_(\"not\" _SimpleExpression)","_((\"not\" _SimpleExpression) | (\"+\" _SimpleExpression) | (\"-\" _SimpleExpression) | (\".+\" _SimpleExpression) | (\".-\" _SimpleExpression))","_(\"+\" _SimpleExpression)","_(\"-\" _SimpleExpression)","_(\".+\" _SimpleExpression)","_(\".-\" _SimpleExpression)","_(_SimpleExpression \"or\" _SimpleExpression)","_((_SimpleExpression \"or\" _SimpleExpression) | (_SimpleExpression \"and\" _SimpleExpression) | (_SimpleExpression \"<\" _SimpleExpression) | (_SimpleExpression \"<=\" _SimpleExpression) | (_SimpleExpression \">\" _SimpleExpression) | (_SimpleExpression \">=\" _SimpleExpression) | (_SimpleExpression \"==\" _SimpleExpression) | (_SimpleExpression \"<>\" _SimpleExpression) | (_SimpleExpression \"+\" _SimpleExpression) | (_SimpleExpression \"-\" _SimpleExpression) | (_SimpleExpression \".+\" _SimpleExpression) | (_SimpleExpression \".-\" _SimpleExpression) | (_SimpleExpression \"*\" _SimpleExpression) | (_SimpleExpression \"/\" _SimpleExpression) | (_SimpleExpression \".*\" _SimpleExpression) | (_SimpleExpression \"./\" _SimpleExpression) | (_PrimaryExpression \"^\" _PrimaryExpression) | (_PrimaryExpression \".^\" _PrimaryExpression))","_(_SimpleExpression \"and\" _SimpleExpression)","_(_SimpleExpression \"<\" _SimpleExpression)","_(_SimpleExpression \"<=\" _SimpleExpression)","_(_SimpleExpression \">\" _SimpleExpression)","_(_SimpleExpression \">=\" _SimpleExpression)","_(_SimpleExpression \"==\" _SimpleExpression)","_(_SimpleExpression \"<>\" _SimpleExpression)","_(_SimpleExpression \"+\" _SimpleExpression)","_(_SimpleExpression \"-\" _SimpleExpression)","_(_SimpleExpression \".+\" _SimpleExpression)","_(_SimpleExpression \".-\" _SimpleExpression)","_(_SimpleExpression \"*\" _SimpleExpression)","_(_SimpleExpression \"/\" _SimpleExpression)","_(_SimpleExpression \".*\" _SimpleExpression)","_(_SimpleExpression \"./\" _SimpleExpression)","_(_PrimaryExpression \"^\" _PrimaryExpression)","_(_PrimaryExpression \".^\" _PrimaryExpression)","_(_Literal | FunctionCall | ComponentReference | MemberAccessExpression | OutputExpressionList | ArrayConcatenation | ArrayConstructor | EndExpression)","EndExpression","_(UNSIGNED_INTEGER | UNSIGNED_REAL | BOOLEAN | STRING)","_(\".\" | ())","_(\".\" IDENT)*","_(\".\" ComponentReferencePart)*","_(ComponentReference | \"der\" | \"initial\" | \"pure\")","_(ComprehensionClause | ((FunctionArgument (\",\" FunctionArgument)*) ((\",\" (NamedArgument (\",\" NamedArgument)*)) | ())) | (NamedArgument (\",\" NamedArgument)*))","_(\",\" FunctionArgument)*","_(\",\" NamedArgument)*","_((\",\" (NamedArgument (\",\" NamedArgument)*)) | ())","_((ComprehensionClause | ((FunctionArgument (\",\" FunctionArgument)*) ((\",\" (NamedArgument (\",\" NamedArgument)*)) | ())) | (NamedArgument (\",\" NamedArgument)*)) | ())","_(\";\" ExpressionList)*","_(ComprehensionClause | ExpressionList)","_((ComprehensionClause | ExpressionList) | ())","_(_Expression | FunctionPartialApplication)","_((NamedArgument (\",\" NamedArgument)*) | ())","_(ArraySubscripts | (\".\" IDENT))","_(_Expression | ())","_(\",\" (_Expression | ()))*","_(((_Expression | ()) (\",\" (_Expression | ()))*) | ())","_(\",\" _Expression)*","_(\",\" Subscript)*","_(\":\" | _Expression)","_(\"+\" STRING)*","_(\"false\" | \"true\")","IDENT","STRING","UNSIGNED_INTEGER","UNSIGNED_REAL","BLOCK_COMMENT","LINE_COMMENT","BOM","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","EOF"] !== "undefined"
    ? ["ERROR","/\\s/","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","\"within\"","\";\"","\"redeclare\"","\"final\"","\"inner\"","\"outer\"","\"replaceable\"","\"encapsulated\"","\"partial\"","\"class\"","\"model\"","\"operator\"","\"record\"","\"block\"","\"expandable\"","\"connector\"","\"type\"","\"package\"","\"pure\"","\"impure\"","\"function\"","\"optimization\"","\"shape\"","\"field\"","\"process\"","\"extends\"","\"end\"","\"=\"","\"input\"","\"output\"","\"enumeration\"","\"(\"","\",\"","\":\"","\")\"","\"der\"","\"external\"","\"protected\"","\"public\"","\"import\"","\".\"","\"{\"","\"}\"","\"*\"","\"constrainedby\"","\"break\"","\"flow\"","\"stream\"","\"discrete\"","\"parameter\"","\"constant\"","\"if\"","\"each\"","\"initial\"","\"equation\"","\"algorithm\"","\"constraint\"","\":=\"","\"<=\"","\">=\"","\"<\"","\">\"","\"return\"","\"then\"","\"else\"","\"elseif\"","\"for\"","\"loop\"","\"in\"","\"while\"","\"when\"","\"elsewhen\"","\"connect\"","\"not\"","\"+\"","\"-\"","\".+\"","\".-\"","\"or\"","\"and\"","\"==\"","\"<>\"","\"/\"","\".*\"","\"./\"","\"^\"","\".^\"","\"[\"","\"]\"","\"annotation\"","\"false\"","\"true\"","/([_a-zA-Z\\u00C0-\\u024F\\u0370-\\u03FF\\u0400-\\u04FF\\u0500-\\u052F\\u0600-\\u06FF\\u0750-\\u077F\\u08A0-\\u08FF\\u0900-\\u097F\\u0980-\\u09FF\\u0A00-\\u0A7F\\u0A80-\\u0AFF\\u0B00-\\u0B7F\\u0B80-\\u0BFF\\u0C00-\\u0C7F\\u0C80-\\u0CFF\\u0D00-\\u0D7F\\u0E00-\\u0E7F\\u0E80-\\u0EFF\\u1000-\\u109F\\u1100-\\u11FF\\u3040-\\u309F\\u30A0-\\u30FF\\u3400-\\u4DBF\\u4E00-\\u9FFF\\uAC00-\\uD7AF\\uFB50-\\uFDFF\\uFE70-\\uFEFF][_a-zA-Z0-9\\u00C0-\\u024F\\u0370-\\u03FF\\u0400-\\u04FF\\u0500-\\u052F\\u0600-\\u06FF\\u0750-\\u077F\\u08A0-\\u08FF\\u0900-\\u097F\\u0980-\\u09FF\\u0A00-\\u0A7F\\u0A80-\\u0AFF\\u0B00-\\u0B7F\\u0B80-\\u0BFF\\u0C00-\\u0C7F\\u0C80-\\u0CFF\\u0D00-\\u0D7F\\u0E00-\\u0E7F\\u0E80-\\u0EFF\\u1000-\\u109F\\u1100-\\u11FF\\u3040-\\u309F\\u30A0-\\u30FF\\u3400-\\u4DBF\\u4E00-\\u9FFF\\uAC00-\\uD7AF\\uFB50-\\uFDFF\\uFE70-\\uFEFF]*|'([^'\\\\]|\\\\.)*')/","/\"([^\"\\\\]|\\\\['\"?\\\\abfnrtv])*\"/","/[0-9]+/","/([0-9]+\\.[0-9]*|[0-9]*\\.[0-9]+)([eE][+-]?[0-9]+)?|[0-9]+[eE][+-]?[0-9]+/","/\\/\\*[^*]*\\*+([^/*][^*]*\\*+)*\\//","/\\/\\/[^\\r\\n]*/","/\\u00EF\\u00BB\\u00BF/","StoredDefinition","WithinDirective","ClassDefinition","ClassPrefixes","_ClassSpecifier","LongClassSpecifier","ShortClassSpecifier","DerClassSpecifier","EnumerationLiteral","ExternalFunctionClause","LanguageSpecification","ExternalFunctionCall","InitialElementSection","ElementSection","_Element","ElementAnnotation","_ImportClause","SimpleImportClause","CompoundImportClause","UnqualifiedImportClause","ExtendsClause","ConstrainingClause","ClassOrInheritanceModification","InheritanceModification","ComponentClause","ComponentDeclaration","ConditionAttribute","Declaration","Modification","ModificationExpression","ClassModification","_ModificationArgument","ElementModification","ElementRedeclaration","ComponentClause1","ComponentDeclaration1","ShortClassDefinition","EquationSection","AlgorithmSection","ConstraintSection","_Equation","_Statement","SimpleAssignmentStatement","ProcedureCallStatement","ComplexAssignmentStatement","SimpleEquation","SpecialEquation","BreakStatement","ReturnStatement","IfEquation","ElseIfEquationClause","IfStatement","ElseIfStatementClause","ForEquation","ForStatement","ForIndex","WhileStatement","WhenEquation","ElseWhenEquationClause","WhenStatement","ElseWhenStatementClause","ConnectEquation","_Expression","IfElseExpression","ElseIfExpressionClause","RangeExpression","_SimpleExpression","UnaryExpression","BinaryExpression","_PrimaryExpression","_Literal","TypeSpecifier","Name","ComponentReference","ComponentReferencePart","FunctionCall","FunctionCallArguments","ArrayConcatenation","ArrayConstructor","ComprehensionClause","NamedArgument","FunctionArgument","FunctionPartialApplication","MemberAccessExpression","OutputExpressionList","ExpressionList","ArraySubscripts","Subscript","Description","AnnotationClause","BOOLEAN","_START","_(BOM | ())","_(WithinDirective | ())","_(ClassDefinition | ComponentClause | _Statement)","_(ClassDefinition | ComponentClause | _Statement)*","_(Name | ())","_(\"redeclare\" | ())","_(\"final\" | ())","_(\"inner\" | ())","_(\"outer\" | ())","_(\"replaceable\" | ())","_(\"encapsulated\" | ())","_(ConstrainingClause | ())","_(\"partial\" | ())","_(\"class\" | \"model\" | ((\"operator\" | ()) \"record\") | \"block\" | ((\"expandable\" | ()) \"connector\") | \"type\" | \"package\" | (((\"pure\" | \"impure\") | ()) (\"operator\" | ()) \"function\") | \"operator\" | \"optimization\" | \"shape\" | \"field\" | \"process\")","_(\"operator\" | ())","_(\"expandable\" | ())","_(\"pure\" | \"impure\")","_((\"pure\" | \"impure\") | ())","_(LongClassSpecifier | ShortClassSpecifier | DerClassSpecifier)","_(\"extends\" | ())","_(ClassModification | ())","_(Description | ())","_(InitialElementSection | ())","_(ElementSection | EquationSection | AlgorithmSection | ConstraintSection)","_(ElementSection | EquationSection | AlgorithmSection | ConstraintSection)*","_(ExternalFunctionClause | ())","_((AnnotationClause \";\") | ())","_(\"input\" | \"output\")","_((\"input\" | \"output\") | ())","_(ArraySubscripts | ())","_((((\"input\" | \"output\") | ()) TypeSpecifier (ArraySubscripts | ()) (ClassModification | ())) | (\"enumeration\" \"(\" (((EnumerationLiteral (\",\" EnumerationLiteral)*) | \":\") | ()) \")\"))","_(\",\" EnumerationLiteral)*","_((EnumerationLiteral (\",\" EnumerationLiteral)*) | \":\")","_(((EnumerationLiteral (\",\" EnumerationLiteral)*) | \":\") | ())","_(AnnotationClause | ())","_(\",\" IDENT)*","_(LanguageSpecification | ())","_(ExternalFunctionCall | ())","_((ComponentReference \"=\") | ())","_(ExpressionList | ())","__Element*","_(\"protected\" | \"public\")","_(ClassDefinition | ComponentClause | ExtendsClause | _ImportClause | ElementAnnotation)","_(AnnotationClause \";\")","_(SimpleImportClause | CompoundImportClause | UnqualifiedImportClause)","_((IDENT \"=\") | ())","_(ClassOrInheritanceModification | ())","_(_ModificationArgument | InheritanceModification)","_(\",\" (_ModificationArgument | InheritanceModification))*","_(((_ModificationArgument | InheritanceModification) (\",\" (_ModificationArgument | InheritanceModification))*) | ())","_(ConnectEquation | IDENT)","_(\"flow\" | \"stream\")","_((\"flow\" | \"stream\") | ())","_(\"discrete\" | \"parameter\" | \"constant\")","_((\"discrete\" | \"parameter\" | \"constant\") | ())","_(\",\" ComponentDeclaration)*","_(ConditionAttribute | ())","_(Modification | ())","_((\"=\" ModificationExpression) | ())","_((ClassModification ((\"=\" ModificationExpression) | ())) | (\"=\" ModificationExpression))","_(_Expression | \"break\")","_(\",\" _ModificationArgument)*","_((_ModificationArgument (\",\" _ModificationArgument)*) | ())","_(ElementModification | ElementRedeclaration)","_(\"each\" | ())","_(ShortClassDefinition | ComponentClause1)","_(\"initial\" | ())","__Equation*","__Statement*","_(SimpleEquation | SpecialEquation | IfEquation | ForEquation | ConnectEquation | WhenEquation)","_(SimpleAssignmentStatement | ProcedureCallStatement | ComplexAssignmentStatement | BreakStatement | ReturnStatement | IfStatement | ForStatement | WhileStatement | WhenStatement)","_(\":=\" | \"=\")","_(\"=\" | \"<=\" | \">=\" | \"<\" | \">\")","_ElseIfEquationClause*","_((\"else\" _Equation*) | ())","_ElseIfStatementClause*","_((\"else\" _Statement*) | ())","_(\",\" ForIndex)*","_((\"in\" _Expression) | ())","_ElseWhenEquationClause*","_ElseWhenStatementClause*","_(IfElseExpression | RangeExpression | _SimpleExpression)","_ElseIfExpressionClause*","_((_SimpleExpression \":\" _SimpleExpression \":\" _SimpleExpression) | (_SimpleExpression \":\" _SimpleExpression))","_(UnaryExpression | BinaryExpression | _PrimaryExpression)","_(\"not\" _SimpleExpression)","_((\"not\" _SimpleExpression) | (\"+\" _SimpleExpression) | (\"-\" _SimpleExpression) | (\".+\" _SimpleExpression) | (\".-\" _SimpleExpression))","_(\"+\" _SimpleExpression)","_(\"-\" _SimpleExpression)","_(\".+\" _SimpleExpression)","_(\".-\" _SimpleExpression)","_(_SimpleExpression \"or\" _SimpleExpression)","_((_SimpleExpression \"or\" _SimpleExpression) | (_SimpleExpression \"and\" _SimpleExpression) | (_SimpleExpression \"<\" _SimpleExpression) | (_SimpleExpression \"<=\" _SimpleExpression) | (_SimpleExpression \">\" _SimpleExpression) | (_SimpleExpression \">=\" _SimpleExpression) | (_SimpleExpression \"==\" _SimpleExpression) | (_SimpleExpression \"<>\" _SimpleExpression) | (_SimpleExpression \"+\" _SimpleExpression) | (_SimpleExpression \"-\" _SimpleExpression) | (_SimpleExpression \".+\" _SimpleExpression) | (_SimpleExpression \".-\" _SimpleExpression) | (_SimpleExpression \"*\" _SimpleExpression) | (_SimpleExpression \"/\" _SimpleExpression) | (_SimpleExpression \".*\" _SimpleExpression) | (_SimpleExpression \"./\" _SimpleExpression) | (_PrimaryExpression \"^\" _PrimaryExpression) | (_PrimaryExpression \".^\" _PrimaryExpression))","_(_SimpleExpression \"and\" _SimpleExpression)","_(_SimpleExpression \"<\" _SimpleExpression)","_(_SimpleExpression \"<=\" _SimpleExpression)","_(_SimpleExpression \">\" _SimpleExpression)","_(_SimpleExpression \">=\" _SimpleExpression)","_(_SimpleExpression \"==\" _SimpleExpression)","_(_SimpleExpression \"<>\" _SimpleExpression)","_(_SimpleExpression \"+\" _SimpleExpression)","_(_SimpleExpression \"-\" _SimpleExpression)","_(_SimpleExpression \".+\" _SimpleExpression)","_(_SimpleExpression \".-\" _SimpleExpression)","_(_SimpleExpression \"*\" _SimpleExpression)","_(_SimpleExpression \"/\" _SimpleExpression)","_(_SimpleExpression \".*\" _SimpleExpression)","_(_SimpleExpression \"./\" _SimpleExpression)","_(_PrimaryExpression \"^\" _PrimaryExpression)","_(_PrimaryExpression \".^\" _PrimaryExpression)","_(_Literal | FunctionCall | ComponentReference | MemberAccessExpression | OutputExpressionList | ArrayConcatenation | ArrayConstructor | EndExpression)","EndExpression","_(UNSIGNED_INTEGER | UNSIGNED_REAL | BOOLEAN | STRING)","_(\".\" | ())","_(\".\" IDENT)*","_(\".\" ComponentReferencePart)*","_(ComponentReference | \"der\" | \"initial\" | \"pure\")","_(ComprehensionClause | ((FunctionArgument (\",\" FunctionArgument)*) ((\",\" (NamedArgument (\",\" NamedArgument)*)) | ())) | (NamedArgument (\",\" NamedArgument)*))","_(\",\" FunctionArgument)*","_(\",\" NamedArgument)*","_((\",\" (NamedArgument (\",\" NamedArgument)*)) | ())","_((ComprehensionClause | ((FunctionArgument (\",\" FunctionArgument)*) ((\",\" (NamedArgument (\",\" NamedArgument)*)) | ())) | (NamedArgument (\",\" NamedArgument)*)) | ())","_(\";\" ExpressionList)*","_(ComprehensionClause | ExpressionList)","_((ComprehensionClause | ExpressionList) | ())","_(_Expression | FunctionPartialApplication)","_((NamedArgument (\",\" NamedArgument)*) | ())","_(ArraySubscripts | (\".\" IDENT))","_(_Expression | ())","_(\",\" (_Expression | ()))*","_(((_Expression | ()) (\",\" (_Expression | ()))*) | ())","_(\",\" _Expression)*","_(\",\" Subscript)*","_(\":\" | _Expression)","_(\"+\" STRING)*","_(\"false\" | \"true\")","IDENT","STRING","UNSIGNED_INTEGER","UNSIGNED_REAL","BLOCK_COMMENT","LINE_COMMENT","BOM","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","UNKNOWN","EOF"]
    : [];
...
export const FIELD_NAMES =
  typeof {"withinDirective":1,"classDefinition":2,"componentClause":3,"statement":4,"packageName":5,"redeclare":6,"final":7,"inner":8,"outer":9,"replaceable":10,"encapsulated":11,"classPrefixes":12,"classSpecifier":13,"constrainingClause":14,"partial":15,"class":16,"model":17,"operator":18,"record":19,"block":20,"expandable":21,"connector":22,"type":23,"package":24,"purity":25,"function":26,"optimization":27,"shape":28,"field":29,"process":30,"extends":31,"identifier":32,"classModification":33,"description":34,"section":35,"externalFunctionClause":36,"annotationClause":37,"endIdentifier":38,"causality":39,"typeSpecifier":40,"arraySubscripts":41,"enumeration":42,"enumerationLiteral":43,"unspecifiedEnumeration":44,"input":45,"languageSpecification":46,"externalFunctionCall":47,"language":48,"output":49,"functionName":50,"arguments":51,"element":52,"visibility":53,"shortName":54,"importName":55,"classOrInheritanceModification":56,"modificationArgumentOrInheritanceModification":57,"connectEquation":58,"flow":59,"variability":60,"componentDeclaration":61,"declaration":62,"conditionAttribute":63,"condition":64,"modification":65,"modificationExpression":66,"expression":67,"break":68,"modificationArgument":69,"each":70,"name":71,"initial":72,"equation":73,"target":74,"source":75,"functionReference":76,"functionCallArguments":77,"outputExpressionList":78,"expression1":79,"expression2":80,"elseIfEquationClause":81,"elseEquation":82,"elseIfStatementClause":83,"elseStatement":84,"forIndex":85,"elseWhenEquationClause":86,"elseWhenStatementClause":87,"componentReference1":88,"componentReference2":89,"elseIfExpressionClause":90,"elseExpression":91,"startExpression":92,"stepExpression":93,"stopExpression":94,"operand":95,"operand1":96,"operand2":97,"global":98,"part":99,"comprehensionClause":100,"argument":101,"namedArgument":102,"expressionList":103,"functionPartialApplication":104,"subscript":105,"flexible":106,"descriptionString":107} !== "undefined" ? {"withinDirective":1,"classDefinition":2,"componentClause":3,"statement":4,"packageName":5,"redeclare":6,"final":7,"inner":8,"outer":9,"replaceable":10,"encapsulated":11,"classPrefixes":12,"classSpecifier":13,"constrainingClause":14,"partial":15,"class":16,"model":17,"operator":18,"record":19,"block":20,"expandable":21,"connector":22,"type":23,"package":24,"purity":25,"function":26,"optimization":27,"shape":28,"field":29,"process":30,"extends":31,"identifier":32,"classModification":33,"description":34,"section":35,"externalFunctionClause":36,"annotationClause":37,"endIdentifier":38,"causality":39,"typeSpecifier":40,"arraySubscripts":41,"enumeration":42,"enumerationLiteral":43,"unspecifiedEnumeration":44,"input":45,"languageSpecification":46,"externalFunctionCall":47,"language":48,"output":49,"functionName":50,"arguments":51,"element":52,"visibility":53,"shortName":54,"importName":55,"classOrInheritanceModification":56,"modificationArgumentOrInheritanceModification":57,"connectEquation":58,"flow":59,"variability":60,"componentDeclaration":61,"declaration":62,"conditionAttribute":63,"condition":64,"modification":65,"modificationExpression":66,"expression":67,"break":68,"modificationArgument":69,"each":70,"name":71,"initial":72,"equation":73,"target":74,"source":75,"functionReference":76,"functionCallArguments":77,"outputExpressionList":78,"expression1":79,"expression2":80,"elseIfEquationClause":81,"elseEquation":82,"elseIfStatementClause":83,"elseStatement":84,"forIndex":85,"elseWhenEquationClause":86,"elseWhenStatementClause":87,"componentReference1":88,"componentReference2":89,"elseIfExpressionClause":90,"elseExpression":91,"startExpression":92,"stepExpression":93,"stopExpression":94,"operand":95,"operand1":96,"operand2":97,"global":98,"part":99,"comprehensionClause":100,"argument":101,"namedArgument":102,"expressionList":103,"functionPartialApplication":104,"subscript":105,"flexible":106,"descriptionString":107} : {};
