...
import type { QueryDB, SpecializationArgs, SymbolEntry, SymbolId } from "@modelscript/language/compiler";
...
export class EnumerationLiteral extends SemanticNode {
  readonly kind = "EnumerationLiteral";
...
export class ExtendsClause extends SemanticNode {
  ...
  // --- Query Accessors ---
  get modificationText(): SemanticNode[] {
    const entries = this.query<SymbolEntry[]>("modificationText");
    return entries.map((e) => wrapEntry(e, this.db));
  }
