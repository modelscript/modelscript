...
| ------------ | --------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `NPM_TOKEN`  | [npmjs.com](https://www.npmjs.com/settings/~/tokens)            | Publish `@modelscript/dsl`, `@modelscript/runtime`, `@modelscript/cli`, etc. |
...
3. **Publish to npm** — `@modelscript/dsl`, `@modelscript/runtime`, `@modelscript/cli`, etc.
