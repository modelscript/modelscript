 ...
 *
 * `TapeOp` describes each operation in the tape, and `StaticTapeBuilder`
 * constructs the tape from a ModelicaExpression AST.  This module is
 * independent of any Modelica compiler / flattener types so it can
