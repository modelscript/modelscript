...
Functional Mock-up Interface (FMI) utilities for ModelScript. Handles importing and exporting FMUs, standardizing the orchestration logic across simulation binaries.
