...
import { buildAdJacobian } from "../evaluator/ad-jacobian.js";
...
export class ArenaSimulator {
  ...
  public executionBlocks: import("../../index.js").ArenaExecutionBlock[] = [];
  ...
  private solveNewtonBlock(
    block: Extract<import("../../index.js").ArenaExecutionBlock, { type: "system" }>,
