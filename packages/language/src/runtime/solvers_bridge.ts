...
export class SolversBridge {
  ...
  /**
   * Runs SUNDIALS CVODE integration over an In-WASM DaeBuilder instance with zero trampoline.
   */
  async simulateDaeWithSundials(
    ...
    const { simulateDaeWithSundials } = await import("../compiler/simulator/solvers/sundials-wasm.js");
