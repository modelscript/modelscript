...
export interface SymbolEntry {
  ...
  resourceId?: string;
  /**
   * The language this symbol belongs to (e.g., "language-a", "language-b").
...
export interface SymbolIndex {
  ...
  /** Parent ID → direct child IDs for O(1) subtree reuse. (null parent mapped to 0 or null) */
 ...
 *
 *   Example: { args: Map<string, unknown>, expression?: unknown }
 */
...
// ---------------------------------------------------------------------------
// Indexer / Ref Hooks (extracted from language DSL)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Source Location & Hierarchy Types
// ---------------------------------------------------------------------------
