...
export function generateAstClasses(specs: ClassSpec[], langName: string): string {
  ...
  lines.push(`// =============================================================================`);
  lines.push(``);
  lines.push(`import type { QueryDB, SymbolEntry, SymbolId, SpecializationArgs } from "@modelscript/language";`);
  lines.push(`import { SemanticNode, GenericNode, type SemanticVisitor } from "@modelscript/language";`);
  lines.push(``);
