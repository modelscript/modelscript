...
import { extractClassSpecs, generateAstClasses } from "../src/generators/ast.js";
...
describe("generateAstClasses", () => {
        ...
        rule: {
          ...
          args: [
            ...
            { type: "field", name: "name", arg: $.name },
            {
              type: "field",
              name: "body",
              arg: { type: "repeat", arg: $.class_definition },
            },
          ],
        },
        options: {
  ...
  it("generates import header", () => {
    ...
    expect(output).toContain("import { SemanticNode, GenericNode, type SemanticVisitor }");
  });
