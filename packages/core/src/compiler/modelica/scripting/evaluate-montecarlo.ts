...
import type { Distribution, MonteCarloOptions, RandomVariable, SolverOptions } from "@modelscript/compiler/simulator";
import { runMonteCarloArena } from "@modelscript/compiler/simulator";
...
import { ModelicaClassInstance } from "../factory.js";
...
function buildMonteCarloResultRecord(
  mcResult: import("@modelscript/compiler/simulator").MonteCarloResult,
  startTime: number,
  stopTime: number,
  numSamples: number,
  messages: string,
