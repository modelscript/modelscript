...
// end TankPID;
// [OpenModelica/flattening/modelica/connectors/TankPID.mo:32:3-32:18:writable] Warning: Connector qOut is not balanced: The number of potential variables (1) is not equal to the number of flow variables (0).
// [OpenModelica/flattening/modelica/connectors/TankPID.mo:11:3-11:60:writable] Warning: Connector cIn is not balanced: The number of potential variables (1) is not equal to the number of flow variables (0).
// [OpenModelica/flattening/modelica/connectors/TankPID.mo:12:3-12:62:writable] Warning: Connector cOut is not balanced: The number of potential variables (1) is not equal to the number of flow variables (0).
// [OpenModelica/flattening/modelica/connectors/TankPID.mo:62:3-62:72:writable] Warning: Connector tSensor is not balanced: The number of potential variables (1) is not equal to the number of flow variables (0).
// [OpenModelica/flattening/modelica/connectors/TankPID.mo:63:3-63:74:writable] Warning: Connector tActuator is not balanced: The number of potential variables (1) is not equal to the number of flow variables (0).
// [OpenModelica/flattening/modelica/connectors/TankPID.mo:64:3-64:74:writable] Warning: Connector qIn is not balanced: The number of potential variables (1) is not equal to the number of flow variables (0).
// [OpenModelica/flattening/modelica/connectors/TankPID.mo:65:3-65:75:writable] Warning: Connector qOut is not balanced: The number of potential variables (1) is not equal to the number of flow variables (0).
// endResult
