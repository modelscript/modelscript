...
//   final parameter Integer n = 30 "Number of sections";
//   parameter Real dL = L / 30.0 "Section length";
//   parameter Real c = 1.0;
//   Real p[1](start = 1.3887943864964021e-11);
//   Real p[2](start = 3.877616759997172e-10);
//   Real p[3](start = 8.535153187561891e-9);
//   Real p[4](start = 1.4810757165736474e-7);
//   Real p[5](start = 2.026108541937632e-6);
//   Real p[6](start = 2.185081592778761e-5);
//   Real p[7](start = 1.857770722946483e-4);
//   Real p[8](start = 0.0012451912931252412);
//   Real p[9](start = 0.0065796007429975364);
//   Real p[10](start = 0.02740832602201249);
//   Real p[11](start = 0.09000880318777135);
//   Real p[12](start = 0.23302738816226257);
//   Real p[13](start = 0.47560723529008253);
//   Real p[14](start = 0.7652607569543711);
//   Real p[15](start = 0.9707109711188355);
//   Real p[16](start = 0.9707109711188355);
//   Real p[17](start = 0.7652607569543711);
//   Real p[18](start = 0.47560723529008253);
//   Real p[19](start = 0.23302738816226257);
//   Real p[20](start = 0.09000880318777146);
//   Real p[21](start = 0.02740832602201244);
//   Real p[22](start = 0.0065796007429975364);
//   Real p[23](start = 0.0012451912931252412);
//   Real p[24](start = 1.8577707229464765e-4);
//   Real p[25](start = 2.1850815927787454e-5);
//   Real p[26](start = 2.0261085419376463e-6);
//   Real p[27](start = 1.481075716573658e-7);
//   Real p[28](start = 8.535153187561891e-9);
//   Real p[29](start = 3.877616759997172e-10);
//   Real p[30](start = 1.3887943864964021e-11);
//   Real dp[1](start = 0.0);
//   Real dp[2](start = 0.0);
//   Real dp[3](start = 0.0);
//   Real dp[4](start = 0.0);
