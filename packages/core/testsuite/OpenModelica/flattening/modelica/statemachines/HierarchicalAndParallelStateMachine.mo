...
//           equation
//             /*Real*/(state1.stateX.i) = 1.0 + previous(state1.stateX.i);
//             state1.stateX.w = state1.v;
//         end state1.stateX;
//         state state1.stateY
//           Integer state1.stateY.j(start = 0);
//           equation
//             /*Real*/(state1.stateY.j) = 1.0 + previous(state1.stateY.j);
//         end state1.stateY;
//         equation
...
//         state state1.stateA
//           equation
//             /*Real*/(state1.v) = 2.0 + previous(state1.v);
//         end state1.stateA;
//         state state1.stateB
//           equation
//             /*Real*/(state1.v) = -1.0 + previous(state1.v);
//         end state1.stateB;
//         state state1.stateC
//           equation
//             /*Real*/(state1.count) = 1.0 + previous(state1.count);
//         end state1.stateC;
//         state state1.stateD
//         end state1.stateD;
//         equation
