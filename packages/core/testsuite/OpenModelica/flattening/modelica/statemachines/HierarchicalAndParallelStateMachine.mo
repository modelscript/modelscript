...
// equation
//   state1.v = previous(state1.v) + 2;
//   state1.v = previous(state1.v) - 1;
//   state1.count = previous(state1.count) + 1;
//   state1.stateX.i = previous(state1.stateX.i) + 1;
//   state1.stateX.w = state1.v;
//   state1.stateY.j = previous(state1.stateY.j) + 1;
...
//   transition(state1.stateA, state1.stateB, v >= 6, false, true, false, 1);
//   transition(state1.stateB, state1.stateC, v == 0, false, true, false, 1);
