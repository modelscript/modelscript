...
//   h := hDryAir * (1.0 - X[1]) + (2.5010145e6 + 1860.0 * (-273.15 + T)) * X[1];
...
//   Real sin_1.medium.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, nominal = 1e5);
//   Real sin_1.medium.h(quantity = "SpecificEnergy", unit = "J/kg");
//   Real sin_1.medium.d(quantity = "Density", unit = "kg/m3", displayUnit = "g/cm3", min = 0.0, max = 1e5, start = 1.0, nominal = 1.0);
//   Real sin_1.medium.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 300.0, nominal = 300.0);
//   Real sin_1.medium.X[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, start = 1.0, nominal = 0.1);
//   Real sin_1.medium.u(quantity = "SpecificEnergy", unit = "J/kg", min = -1e8, max = 1e8, nominal = 1e6);
//   Real sin_1.medium.R(quantity = "SpecificHeatCapacity", unit = "J/(kg.K)", min = 0.0, max = 1e7, start = 1000.0, nominal = 1000.0);
//   Real sin_1.medium.MM(quantity = "MolarMass", unit = "kg/mol", min = 0.001, max = 0.25, nominal = 0.032);
//   Real sin_1.medium.state.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 3e5, nominal = 1e5);
//   Real sin_1.medium.state.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 293.15, nominal = 300.0);
...
//   Real sin_1.ports[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if sin_1.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Entering then 0.0 else -1e60, max = if sin_1.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Leaving then 0.0 else 1e60);
//   Real sin_1.ports[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real sin_1.ports[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   parameter Real sin_1.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5) = 3e5;
//   parameter Real sin_1.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 300.0, nominal = 300.0) = 283.15;
...
//   parameter Real sou_1.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5) = 101335.0;
//   parameter Real sou_1.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 300.0, nominal = 300.0) = 293.15;
...
//   Real res_1.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if res_1.allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real res_1.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 3e5, nominal = 3e5);
//   Real res_1.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real res_1.port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if res_1.allowFlowReversal then 1e60 else 0.0);
//   Real res_1.port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 3e5, nominal = 3e5);
//   Real res_1.port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   parameter Real res_1.m_flow_small(quantity = "MassFlowRate", unit = "kg/s", min = 0.0) = 1e-4 * abs(res_1.m_flow_nominal);
...
//   protected parameter Real res_1.sta_default.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 3e5, nominal = 1e5) = 3e5;
//   protected parameter Real res_1.sta_default.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 293.15, nominal = 300.0) = 293.15;
...
//   Real mfr_1[1].port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if mfr_1[1].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_1[1].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_1[1].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_1[1].port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if mfr_1[1].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_1[1].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_1[1].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_1[2].port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if mfr_1[2].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_1[2].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_1[2].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_1[2].port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if mfr_1[2].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_1[2].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_1[2].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_1[3].port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if mfr_1[3].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_1[3].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_1[3].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_1[3].port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if mfr_1[3].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_1[3].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_1[3].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real pipFixRes_1.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pipFixRes_1.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = pipFixRes_1.mStart_flow_a);
//   Real pipFixRes_1.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipFixRes_1.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipFixRes_1.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipFixRes_1.allowFlowReversal then 1e60 else 0.0, start = (-pipFixRes_1.mStart_flow_a) / /*Real*/(pipFixRes_1.nPipPar));
//   Real pipFixRes_1.port_b[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipFixRes_1.port_b[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipFixRes_1.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipFixRes_1.allowFlowReversal then 1e60 else 0.0, start = (-pipFixRes_1.mStart_flow_a) / /*Real*/(pipFixRes_1.nPipPar));
//   Real pipFixRes_1.port_b[2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipFixRes_1.port_b[2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipFixRes_1.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipFixRes_1.allowFlowReversal then 1e60 else 0.0, start = (-pipFixRes_1.mStart_flow_a) / /*Real*/(pipFixRes_1.nPipPar));
//   Real pipFixRes_1.port_b[3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipFixRes_1.port_b[3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real pipFixRes_1.fixRes.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pipFixRes_1.fixRes.allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real pipFixRes_1.fixRes.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 3e5, nominal = 3e5);
//   Real pipFixRes_1.fixRes.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipFixRes_1.fixRes.port_b.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipFixRes_1.fixRes.allowFlowReversal then 1e60 else 0.0);
//   Real pipFixRes_1.fixRes.port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 3e5, nominal = 3e5);
//   Real pipFixRes_1.fixRes.port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   parameter Real pipFixRes_1.fixRes.m_flow_small(quantity = "MassFlowRate", unit = "kg/s", min = 0.0) = 1e-4 * abs(pipFixRes_1.fixRes.m_flow_nominal);
...
//   protected parameter Real pipFixRes_1.fixRes.sta_default.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 3e5, nominal = 1e5) = 3e5;
//   protected parameter Real pipFixRes_1.fixRes.sta_default.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 293.15, nominal = 300.0) = 293.15;
...
//   protected Real pipFixRes_1.floDis.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pipFixRes_1.floDis.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = pipFixRes_1.floDis.mStart_flow_a);
//   protected Real pipFixRes_1.floDis.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real pipFixRes_1.floDis.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real pipFixRes_1.floDis.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipFixRes_1.floDis.allowFlowReversal then 1e60 else 0.0, start = (-pipFixRes_1.floDis.mStart_flow_a) / /*Real*/(pipFixRes_1.floDis.nPipPar));
//   protected Real pipFixRes_1.floDis.port_b[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real pipFixRes_1.floDis.port_b[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real pipFixRes_1.floDis.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipFixRes_1.floDis.allowFlowReversal then 1e60 else 0.0, start = (-pipFixRes_1.floDis.mStart_flow_a) / /*Real*/(pipFixRes_1.floDis.nPipPar));
//   protected Real pipFixRes_1.floDis.port_b[2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real pipFixRes_1.floDis.port_b[2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real pipFixRes_1.floDis.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipFixRes_1.floDis.allowFlowReversal then 1e60 else 0.0, start = (-pipFixRes_1.floDis.mStart_flow_a) / /*Real*/(pipFixRes_1.floDis.nPipPar));
//   protected Real pipFixRes_1.floDis.port_b[3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real pipFixRes_1.floDis.port_b[3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real pipNoRes_1.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if pipNoRes_1.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = pipNoRes_1.mStart_flow_a);
//   Real pipNoRes_1.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipNoRes_1.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipNoRes_1.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipNoRes_1.allowFlowReversal then 1e60 else 0.0, start = (-pipNoRes_1.mStart_flow_a) / /*Real*/(pipNoRes_1.nPipPar));
//   Real pipNoRes_1.port_b[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipNoRes_1.port_b[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipNoRes_1.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipNoRes_1.allowFlowReversal then 1e60 else 0.0, start = (-pipNoRes_1.mStart_flow_a) / /*Real*/(pipNoRes_1.nPipPar));
//   Real pipNoRes_1.port_b[2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipNoRes_1.port_b[2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipNoRes_1.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if pipNoRes_1.allowFlowReversal then 1e60 else 0.0, start = (-pipNoRes_1.mStart_flow_a) / /*Real*/(pipNoRes_1.nPipPar));
//   Real pipNoRes_1.port_b[3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipNoRes_1.port_b[3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   parameter Boolean pipNoRes_1.connectAllPressures = true;
//   parameter Integer pipNoRes_1.mulPor.nPorts_b = pipNoRes_1.nPipPar;
//   Real pipNoRes_1.mulPor.port_a.m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = 1e5);
//   Real pipNoRes_1.mulPor.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipNoRes_1.mulPor.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipNoRes_1.mulPor.ports_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = 1e5);
//   Real pipNoRes_1.mulPor.ports_b[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipNoRes_1.mulPor.ports_b[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipNoRes_1.mulPor.ports_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = 1e5);
//   Real pipNoRes_1.mulPor.ports_b[2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipNoRes_1.mulPor.ports_b[2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real pipNoRes_1.mulPor.ports_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = 1e5);
//   Real pipNoRes_1.mulPor.ports_b[3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real pipNoRes_1.mulPor.ports_b[3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   parameter Boolean res_2.allowFlowReversal = system.allowFlowReversal;
//   Real res_2.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if res_2.allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real res_2.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 101325.0, nominal = 101325.0);
//   Real res_2.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real res_2.port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real res_2.port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if res_2.allowFlowReversal then 1e60 else 0.0);
//   Real res_2.port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 101325.0, nominal = 101325.0);
//   Real res_2.port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   parameter Real res_2.m_flow_small(quantity = "MassFlowRate", unit = "kg/s", min = 0.0) = 1e-4 * abs(res_2.m_flow_nominal);
...
//   protected parameter Real res_2.sta_default.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5) = 101325.0;
//   protected parameter Real res_2.sta_default.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 300.0, nominal = 300.0) = 293.15;
...
//   Real mfr_2[1,1].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[1,1].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[1,1].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[1,1].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[1,1].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[1,1].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[1,1].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[1,1].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[1,1].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[1,2].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[1,2].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[1,2].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[1,2].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[1,2].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[1,2].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[1,2].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[1,2].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[1,2].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[1,3].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[1,3].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[1,3].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[1,3].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[1,3].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[1,3].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[1,3].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[1,3].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[1,3].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[1,4].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[1,4].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[1,4].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[1,4].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[1,4].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[1,4].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[1,4].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[1,4].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[1,4].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[2,1].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[2,1].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[2,1].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[2,1].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[2,1].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[2,1].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[2,1].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[2,1].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[2,1].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[2,2].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[2,2].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[2,2].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[2,2].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[2,2].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[2,2].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[2,2].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[2,2].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[2,2].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[2,3].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[2,3].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[2,3].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[2,3].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[2,3].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[2,3].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[2,3].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[2,3].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[2,3].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[2,4].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[2,4].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[2,4].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[2,4].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[2,4].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[2,4].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[2,4].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[2,4].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[2,4].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[3,1].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[3,1].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[3,1].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[3,1].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[3,1].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[3,1].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[3,1].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[3,1].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[3,1].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[3,2].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[3,2].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[3,2].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[3,2].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[3,2].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[3,2].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[3,2].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[3,2].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[3,2].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[3,3].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[3,3].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[3,3].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[3,3].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[3,3].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[3,3].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[3,3].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[3,3].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[3,3].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real mfr_2[3,4].port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if mfr_2[3,4].allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real mfr_2[3,4].port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[3,4].port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real mfr_2[3,4].port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real mfr_2[3,4].port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if mfr_2[3,4].allowFlowReversal then 1e60 else 0.0);
//   Real mfr_2[3,4].port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real mfr_2[3,4].port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real ducFixRes_2.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if ducFixRes_2.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = ducFixRes_2.mStart_flow_a);
//   Real ducFixRes_2.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real ducFixRes_2.port_b[1,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[1,1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[1,1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[1,1].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[1,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[1,2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[1,2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[1,2].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[1,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[1,3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[1,3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[1,3].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[1,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[1,4].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[1,4].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[1,4].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[2,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[2,1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[2,1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[2,1].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[2,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[2,2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[2,2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[2,2].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[2,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[2,3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[2,3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[2,3].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[2,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[2,4].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[2,4].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[2,4].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[3,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[3,1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[3,1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[3,1].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[3,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[3,2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[3,2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[3,2].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[3,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[3,3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[3,3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.port_b[3,3].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.port_b[3,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.mStart_flow_a) / (/*Real*/(ducFixRes_2.nPipPar) * /*Real*/(ducFixRes_2.nPipSeg)));
//   Real ducFixRes_2.port_b[3,4].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducFixRes_2.port_b[3,4].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real ducFixRes_2.fixRes.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if ducFixRes_2.fixRes.allowFlowReversal then -1e60 else 0.0, max = 1e5);
//   Real ducFixRes_2.fixRes.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 101325.0, nominal = 101325.0);
//   Real ducFixRes_2.fixRes.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducFixRes_2.fixRes.port_a.Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducFixRes_2.fixRes.port_b.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.fixRes.allowFlowReversal then 1e60 else 0.0);
//   Real ducFixRes_2.fixRes.port_b.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 101325.0, nominal = 101325.0);
//   Real ducFixRes_2.fixRes.port_b.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   parameter Real ducFixRes_2.fixRes.m_flow_small(quantity = "MassFlowRate", unit = "kg/s", min = 0.0) = 1e-4 * abs(ducFixRes_2.fixRes.m_flow_nominal);
...
//   protected parameter Real ducFixRes_2.fixRes.sta_default.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5) = 101325.0;
//   protected parameter Real ducFixRes_2.fixRes.sta_default.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 300.0, nominal = 300.0) = 293.15;
...
//   protected Real ducFixRes_2.floDis.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if ducFixRes_2.floDis.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = ducFixRes_2.floDis.mStart_flow_a);
//   protected Real ducFixRes_2.floDis.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   protected Real ducFixRes_2.floDis.port_b[1,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[1,1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[1,1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[1,1].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[1,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[1,2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[1,2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[1,2].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[1,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[1,3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[1,3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[1,3].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[1,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[1,4].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[1,4].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[1,4].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[2,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[2,1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[2,1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[2,1].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[2,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[2,2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[2,2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[2,2].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[2,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[2,3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[2,3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[2,3].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[2,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[2,4].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[2,4].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[2,4].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[3,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[3,1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[3,1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[3,1].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[3,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[3,2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[3,2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[3,2].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[3,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[3,3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[3,3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   protected Real ducFixRes_2.floDis.port_b[3,3].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real ducFixRes_2.floDis.port_b[3,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducFixRes_2.floDis.allowFlowReversal then 1e60 else 0.0, start = (-ducFixRes_2.floDis.mStart_flow_a) / (/*Real*/(ducFixRes_2.floDis.nPipPar) * /*Real*/(ducFixRes_2.floDis.nPipSeg)));
//   protected Real ducFixRes_2.floDis.port_b[3,4].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   protected Real ducFixRes_2.floDis.port_b[3,4].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real ducNoRes_2.port_a.m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if ducNoRes_2.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = ducNoRes_2.mStart_flow_a);
//   Real ducNoRes_2.port_a.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_a.h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real ducNoRes_2.port_b[1,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[1,1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[1,1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[1,1].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[1,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[1,2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[1,2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[1,2].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[1,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[1,3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[1,3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[1,3].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[1,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[1,4].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[1,4].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[1,4].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[2,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[2,1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[2,1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[2,1].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[2,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[2,2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[2,2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[2,2].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[2,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[2,3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[2,3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[2,3].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[2,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[2,4].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[2,4].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[2,4].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[3,1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[3,1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[3,1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[3,1].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[3,2].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[3,2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[3,2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[3,2].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[3,3].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[3,3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[3,3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real ducNoRes_2.port_b[3,3].Xi_outflow[1](quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   Real ducNoRes_2.port_b[3,4].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = -1e5, max = if ducNoRes_2.allowFlowReversal then 1e60 else 0.0, start = (-ducNoRes_2.mStart_flow_a) / (/*Real*/(ducNoRes_2.nPipPar) * /*Real*/(ducNoRes_2.nPipSeg)));
//   Real ducNoRes_2.port_b[3,4].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real ducNoRes_2.port_b[3,4].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real hea1.port_a[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea1.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = hea1.mStart_flow_a / /*Real*/(hea1.nPipPar));
//   Real hea1.port_a[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea1.port_a[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea1.port_a[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea1.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = hea1.mStart_flow_a / /*Real*/(hea1.nPipPar));
//   Real hea1.port_a[2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea1.port_a[2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea1.port_a[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea1.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = hea1.mStart_flow_a / /*Real*/(hea1.nPipPar));
//   Real hea1.port_a[3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea1.port_a[3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea1.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if hea1.allowFlowReversal then 1e60 else 0.0, start = (-hea1.mStart_flow_a) / /*Real*/(hea1.nPipPar));
//   Real hea1.port_b[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea1.port_b[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea1.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if hea1.allowFlowReversal then 1e60 else 0.0, start = (-hea1.mStart_flow_a) / /*Real*/(hea1.nPipPar));
//   Real hea1.port_b[2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea1.port_b[2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea1.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if hea1.allowFlowReversal then 1e60 else 0.0, start = (-hea1.mStart_flow_a) / /*Real*/(hea1.nPipPar));
//   Real hea1.port_b[3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea1.port_b[3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real hea2.port_a[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea2.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = hea2.mStart_flow_a / /*Real*/(hea2.nPipPar));
//   Real hea2.port_a[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea2.port_a[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea2.port_a[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea2.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = hea2.mStart_flow_a / /*Real*/(hea2.nPipPar));
//   Real hea2.port_a[2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea2.port_a[2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea2.port_a[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = if hea2.allowFlowReversal then -1e60 else 0.0, max = 1e5, start = hea2.mStart_flow_a / /*Real*/(hea2.nPipPar));
//   Real hea2.port_a[3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea2.port_a[3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea2.port_b[1].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if hea2.allowFlowReversal then 1e60 else 0.0, start = (-hea2.mStart_flow_a) / /*Real*/(hea2.nPipPar));
//   Real hea2.port_b[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea2.port_b[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea2.port_b[2].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if hea2.allowFlowReversal then 1e60 else 0.0, start = (-hea2.mStart_flow_a) / /*Real*/(hea2.nPipPar));
//   Real hea2.port_b[2].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea2.port_b[2].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
//   Real hea2.port_b[3].m_flow(quantity = "MassFlowRate.SimpleLiquidWater", unit = "kg/s", min = -1e5, max = if hea2.allowFlowReversal then 1e60 else 0.0, start = (-hea2.mStart_flow_a) / /*Real*/(hea2.nPipPar));
//   Real hea2.port_b[3].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real hea2.port_b[3].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   Real sou_2.medium.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, nominal = 1e5);
...
//   Real sou_2.medium.d(quantity = "Density", unit = "kg/m3", displayUnit = "g/cm3", min = 0.0, max = 1e5, start = 1.0, nominal = 1.0);
//   Real sou_2.medium.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 300.0, nominal = 300.0);
...
//   Real sou_2.medium.u(quantity = "SpecificEnergy", unit = "J/kg", min = -1e8, max = 1e8, nominal = 1e6);
//   Real sou_2.medium.R(quantity = "SpecificHeatCapacity", unit = "J/(kg.K)", min = 0.0, max = 1e7, start = 1000.0, nominal = 1000.0);
//   Real sou_2.medium.MM(quantity = "MolarMass", unit = "kg/mol", min = 0.001, max = 0.25, nominal = 0.032);
//   Real sou_2.medium.state.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real sou_2.medium.state.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 300.0, nominal = 300.0);
...
//   protected Real sou_2.medium.x_sat(quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real sou_2.medium.p_steam_sat(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real sou_2.ports[1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if sou_2.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Entering then 0.0 else -1e60, max = if sou_2.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Leaving then 0.0 else 1e60);
//   Real sou_2.ports[1].p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real sou_2.ports[1].h_outflow(quantity = "SpecificEnergy", unit = "J/kg", min = -1e10, max = 1e10, nominal = 1e6);
...
//   parameter Real sou_2.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5) = 101335.0;
//   parameter Real sou_2.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 300.0, nominal = 300.0) = 293.15;
...
//   Real sin_2.medium.state.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real sin_2.medium.state.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 1.0, max = 1e4, start = 300.0, nominal = 300.0);
...
//   protected Real sin_2.medium.x_sat(quantity = "MassFraction", unit = "kg/kg", min = 0.0, max = 1.0, nominal = 0.1);
//   protected Real sin_2.medium.p_steam_sat(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5);
//   Real sin_2.ports[1].m_flow(quantity = "MassFlowRate.Moist air unsaturated perfect gas", unit = "kg/s", min = if sin_2.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Entering then 0.0 else -1e60, max = if sin_2.flowDirection == Modelica.Fluid.Types.PortFlowDirection.Leaving then 0.0 else 1e60);
...
//   parameter Real sin_2.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, max = 1e8, start = 1e5, nominal = 1e5) = 101325.0;
...
//   assert(sin_1.medium.X[1] >= -1e-5 and sin_1.medium.X[1] <= 1.00001, "Mass fraction X[1] = " + String(sin_1.medium.X[1], 6, 0, true) + "of substance " + "SimpleLiquidWater" + "
...
//   sou_2.medium.MM = 1.0 / (34.52428788658843 + 20.984147175203553 * sou_2.medium.Xi[1]);
...
//   assert(sou_2.medium.X[1] >= -1e-5 and sou_2.medium.X[1] <= 1.00001, "Mass fraction X[1] = " + String(sou_2.medium.X[1], 6, 0, true) + "of substance " + "water" + "
//   of medium " + "Moist air unsaturated perfect gas" + " is not in the range 0..1");
//   assert(sou_2.medium.X[2] >= -1e-5 and sou_2.medium.X[2] <= 1.00001, "Mass fraction X[2] = " + String(sou_2.medium.X[2], 6, 0, true) + "of substance " + "air" + "
//   of medium " + "Moist air unsaturated perfect gas" + " is not in the range 0..1");
...
//             required from medium model \"" + "Moist air unsaturated perfect gas" + "\".");
//   sin_2.medium.MM = 1.0 / (34.52428788658843 + 20.984147175203553 * sin_2.medium.Xi[1]);
...
//   assert(sin_2.medium.X[1] >= -1e-5 and sin_2.medium.X[1] <= 1.00001, "Mass fraction X[1] = " + String(sin_2.medium.X[1], 6, 0, true) + "of substance " + "water" + "
//   of medium " + "Moist air unsaturated perfect gas" + " is not in the range 0..1");
//   assert(sin_2.medium.X[2] >= -1e-5 and sin_2.medium.X[2] <= 1.00001, "Mass fraction X[2] = " + String(sin_2.medium.X[2], 6, 0, true) + "of substance " + "air" + "
//   of medium " + "Moist air unsaturated perfect gas" + " is not in the range 0..1");
...
//   ducNoRes_2.port_b[1,1].Xi_outflow[1] = ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) * res_2.port_a.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) * mfr_2[3,4].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) * mfr_2[3,3].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) * mfr_2[3,2].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) * mfr_2[3,1].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) * mfr_2[2,4].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) * mfr_2[2,3].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) * mfr_2[2,2].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) * mfr_2[2,1].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) * mfr_2[1,4].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[1,3].m_flow, 1e-7) * mfr_2[1,3].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[1,2].m_flow, 1e-7) * mfr_2[1,2].port_b.Xi_outflow[1]) / ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,2].m_flow, 1e-7)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,2].Xi_outflow[1] = ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) * res_2.port_a.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) * mfr_2[3,4].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) * mfr_2[3,3].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) * mfr_2[3,2].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) * mfr_2[3,1].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) * mfr_2[2,4].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) * mfr_2[2,3].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) * mfr_2[2,2].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) * mfr_2[2,1].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) * mfr_2[1,4].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[1,3].m_flow, 1e-7) * mfr_2[1,3].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[1,1].m_flow, 1e-7) * mfr_2[1,1].port_b.Xi_outflow[1]) / ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,1].m_flow, 1e-7)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,3].Xi_outflow[1] = ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) * res_2.port_a.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) * mfr_2[3,4].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) * mfr_2[3,3].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) * mfr_2[3,2].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) * mfr_2[3,1].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) * mfr_2[2,4].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) * mfr_2[2,3].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) * mfr_2[2,2].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) * mfr_2[2,1].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) * mfr_2[1,4].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[1,2].m_flow, 1e-7) * mfr_2[1,2].port_b.Xi_outflow[1] + $OMC$PositiveMax(ducNoRes_2.port_b[1,1].m_flow, 1e-7) * mfr_2[1,1].port_b.Xi_outflow[1]) / ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,1].m_flow, 1e-7)) " equation generated by stream handling";
...
//   ducNoRes_2.port_b[1,1].h_outflow = ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) * res_2.port_a.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) * mfr_2[3,4].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) * mfr_2[3,3].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) * mfr_2[3,2].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) * mfr_2[3,1].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) * mfr_2[2,4].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) * mfr_2[2,3].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) * mfr_2[2,2].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) * mfr_2[2,1].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) * mfr_2[1,4].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[1,3].m_flow, 1e-7) * mfr_2[1,3].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[1,2].m_flow, 1e-7) * mfr_2[1,2].port_b.h_outflow) / ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,2].m_flow, 1e-7)) " equation generated by stream handling";
//   ducNoRes_2.port_b[1,2].h_outflow = ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) * res_2.port_a.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) * mfr_2[3,4].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) * mfr_2[3,3].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) * mfr_2[3,2].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) * mfr_2[3,1].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) * mfr_2[2,4].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) * mfr_2[2,3].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) * mfr_2[2,2].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) * mfr_2[2,1].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) * mfr_2[1,4].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[1,3].m_flow, 1e-7) * mfr_2[1,3].port_b.h_outflow + $OMC$PositiveMax(ducNoRes_2.port_b[1,1].m_flow, 1e-7) * mfr_2[1,1].port_b.h_outflow) / ($OMC$PositiveMax(ducNoRes_2.port_a.m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[3,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,2].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[2,1].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,4].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,3].m_flow, 1e-7) + $OMC$PositiveMax(ducNoRes_2.port_b[1,1].m_flow, 1e-7)) " equation generated by stream handling";
