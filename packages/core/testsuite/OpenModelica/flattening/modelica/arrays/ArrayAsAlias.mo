...
//   parameter Real w.gravityArrowTail[1](quantity = "Length", unit = "m") = 0.0;
//   parameter Real w.gravityArrowTail[2](quantity = "Length", unit = "m") = 0.0;
//   parameter Real w.gravityArrowTail[3](quantity = "Length", unit = "m") = 0.0;
...
//   parameter Real w.defaultAxisLength(quantity = "Length", unit = "m") = 0.2 "Default for length of a frame axis (but not world frame)";
//   parameter Real w.defaultJointLength(quantity = "Length", unit = "m") = 0.1 "Default for the fixed length of a shape representing a joint";
//   parameter Real w.defaultJointWidth(quantity = "Length", unit = "m") = 0.05 "Default for the fixed width of a shape representing a joint";
//   parameter Real w.defaultForceLength(quantity = "Length", unit = "m") = 0.1 "Default for the fixed length of a shape representing a force (e.g. damper)";
//   parameter Real w.defaultForceWidth(quantity = "Length", unit = "m") = 0.05 "Default for the fixed width of a shape represening a force (e.g. spring, bushing)";
//   parameter Real w.defaultBodyDiameter(quantity = "Length", unit = "m") = 0.1111111111111111 "Default for diameter of sphere representing the center of mass of a body";
...
//   parameter Real w.defaultArrowDiameter(quantity = "Length", unit = "m") = 0.025 "Default for arrow diameter (e.g., of forces, torques, sensors)";
