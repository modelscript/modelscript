...
//   parameter Real w.g(unit = "m/s2", quantity = "Acceleration") = 9.81 "Constant gravity acceleration";
...
//   parameter Real w.axisLength(unit = "m", min = 0.0, quantity = "Length") = 0.5 * w.nominalLength "Length of world axes arrows";
//   parameter Real w.axisDiameter(unit = "m", min = 0.0, quantity = "Length") = w.axisLength / w.defaultFrameDiameterFraction "Diameter of world axes arrows";
//   parameter Boolean w.axisShowLabels = true "= true, if labels shall be shown";
//   parameter Real w.gravityArrowTail[1](unit = "m", quantity = "Length") = 0.0;
//   parameter Real w.gravityArrowTail[2](unit = "m", quantity = "Length") = 0.0;
//   parameter Real w.gravityArrowTail[3](unit = "m", quantity = "Length") = 0.0;
//   parameter Real w.gravityArrowLength(unit = "m", quantity = "Length") = 0.5 * w.axisLength "Length of gravity arrow";
//   parameter Real w.gravityArrowDiameter(unit = "m", min = 0.0, quantity = "Length") = w.gravityArrowLength / w.defaultWidthFraction "Diameter of gravity arrow";
//   parameter Real w.gravitySphereDiameter(unit = "m", min = 0.0, quantity = "Length") = 12742000.0 "Diameter of sphere representing gravity center (default = mean diameter of earth)";
//   parameter Real w.nominalLength(unit = "m", quantity = "Length") = 1.0 ""Nominal" length of multi-body system";
//   parameter Real w.defaultAxisLength(unit = "m", quantity = "Length") = 0.2 "Default for length of a frame axis (but not world frame)";
//   parameter Real w.defaultJointLength(unit = "m", quantity = "Length") = 0.1 "Default for the fixed length of a shape representing a joint";
//   parameter Real w.defaultJointWidth(unit = "m", quantity = "Length") = 0.05 "Default for the fixed width of a shape representing a joint";
//   parameter Real w.defaultForceLength(unit = "m", quantity = "Length") = 0.1 "Default for the fixed length of a shape representing a force (e.g. damper)";
//   parameter Real w.defaultForceWidth(unit = "m", quantity = "Length") = 0.05 "Default for the fixed width of a shape represening a force (e.g. spring, bushing)";
//   parameter Real w.defaultBodyDiameter(unit = "m", quantity = "Length") = 0.1111111111111111 "Default for diameter of sphere representing the center of mass of a body";
...
//   parameter Real w.defaultArrowDiameter(unit = "m", quantity = "Length") = 0.025 "Default for arrow diameter (e.g., of forces, torques, sensors)";
