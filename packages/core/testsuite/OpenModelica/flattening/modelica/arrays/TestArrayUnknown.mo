...
//
// [OpenModelica/flattening/modelica/arrays/TestArrayUnknown.mo:13:3-13:12:writable] Error: Could not evaluate structural parameter (or constant): p which gives dimensions of array: blah[p]. Array dimensions must be known at compile time.
