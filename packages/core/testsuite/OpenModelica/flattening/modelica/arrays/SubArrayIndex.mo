...
//
// Result:
// Error processing file: SubArrayIndex.mo
// # Error encountered! Exiting...
// # Please check the error message and the flags.
//
// [OpenModelica/flattening/modelica/arrays/SubArrayIndex.mo:18:3-18:24:writable] Error: Type mismatch in assignment in M[4,:] := {{5, 5}, {5, 5}, {5, 5}, {5, 5}} of Real[2] := Integer[4, 2]
// Error: Error occurred while flattening model SubArrayIndex
//
// Execution failed!
// endResult
