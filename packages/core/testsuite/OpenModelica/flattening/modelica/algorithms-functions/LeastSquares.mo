...
//   protected Integer lwork = min(size(A, 1), size(A, 2)) + 32.0 * max(max(size(A, 1), size(A, 2)), size(B, 2));
...
//   in1 = {{1.0, 3.0}, {4.0, 1.0}};
//   in2 = {{4.0, 2.0}, {5.0, 3.0}};
//   x = ls({{in1[1,1], in1[1,2]}, {in1[2,1], in1[2,2]}}, {{in2[1,1], in2[1,2]}, {in2[2,1], in2[2,2]}});
// end LeastSquares;
// [flattening/modelica/algorithms-functions/LeastSquares.mo:12:42-12:45] Error: [M4003] Array dimension mismatch: expression has shape [0] but expected [0,0].
// endResult
