...
// Result:
// Error processing file: OperatorOverloadComplex.mo
// Error: Failed to load package OperatorOverloadComplex (default) using MODELICAPATH /home/omar/.openmodelica/libraries/.
// Error: Class OperatorOverloadComplex.mo not found in scope <top>.
// Error: Error occurred while flattening model OperatorOverloadComplex.mo
//
