...
// end UnboundParameter4;
// [OpenModelica/flattening/modelica/scodeinst/UnboundParameter4.mo:7:3-7:41:writable] Warning: Parameter a.x has no value, and is fixed during initialization (fixed=true), using available start value (start={0, 0, 0}) as default value.
// endResult
