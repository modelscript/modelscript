...
//   final parameter Boolean m2A[1].useM1 = true;
//   Real m2A[1].port1.foo;
//   Real m2A[1].port1.fooFlow;
//   Real m2A[1].port2.foo;
//   Real m2A[1].port2.fooFlow;
//   Real m2A[1].m1.port1.foo;
//   Real m2A[1].m1.port1.fooFlow;
//   Real m2A[1].m1.port2.foo;
//   Real m2A[1].m1.port2.fooFlow;
//   final parameter Boolean m2A[2].useM1 = true;
//   Real m2A[2].port1.foo;
//   Real m2A[2].port1.fooFlow;
//   Real m2A[2].port2.foo;
//   Real m2A[2].port2.fooFlow;
//   Real m2A[2].m1.port1.foo;
//   Real m2A[2].m1.port1.fooFlow;
//   Real m2A[2].m1.port2.foo;
//   Real m2A[2].m1.port2.fooFlow;
//   final parameter Boolean m2A[3].useM1 = true;
//   Real m2A[3].port1.foo;
//   Real m2A[3].port1.fooFlow;
//   Real m2A[3].port2.foo;
//   Real m2A[3].port2.fooFlow;
//   Real m2A[3].m1.port1.foo;
//   Real m2A[3].m1.port1.fooFlow;
//   Real m2A[3].m1.port2.foo;
//   Real m2A[3].m1.port2.fooFlow;
// equation
...
//   m2A[1].m1.port1.fooFlow + m2A[1].m1.port2.fooFlow = 0.0;
//   m2A[1].m1.port1.fooFlow = m2A[1].m1.port1.foo - m2A[1].m1.port2.foo;
//   m2A[2].m1.port1.fooFlow + m2A[2].m1.port2.fooFlow = 0.0;
//   m2A[2].m1.port1.fooFlow = m2A[2].m1.port1.foo - m2A[2].m1.port2.foo;
//   m2A[3].m1.port1.fooFlow + m2A[3].m1.port2.fooFlow = 0.0;
//   m2A[3].m1.port1.fooFlow = m2A[3].m1.port1.foo - m2A[3].m1.port2.foo;
// end NoScalarizeConnect3;
// endResult
