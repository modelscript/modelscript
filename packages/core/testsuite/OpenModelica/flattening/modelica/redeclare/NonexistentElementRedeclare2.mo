...
//
// [OpenModelica/flattening/modelica/redeclare/NonexistentElementRedeclare2.mo:9:13-9:26:writable] Error: Illegal redeclare of element C, no inherited element with that name exists.
