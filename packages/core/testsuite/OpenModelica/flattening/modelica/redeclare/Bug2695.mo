...
//   final constant Boolean gas_pT1.gasType.fixedMixingRatio = false;
//   final constant Integer gas_pT1.gasType.nc_propertyCalculation(min = 1) = 2;
//   final constant Integer gas_pT1.gasType.nc = 2;
//   final constant String gas_pT1.gasType.gasNames[1] = "VDIWA.Water";
//   final constant String gas_pT1.gasType.gasNames[2] = "VDIWA.DryAir";
//   final constant Real gas_pT1.gasType.mixingRatio_propertyCalculation[1] = 0.001;
//   final constant Real gas_pT1.gasType.mixingRatio_propertyCalculation[2] = 1.0;
//   constant Real gas_pT1.gasType.defaultMixingRatio[1] = 0.001;
//   constant Real gas_pT1.gasType.defaultMixingRatio[2] = 1.0;
//   constant Real gas_pT1.gasType.xi_default[1] = 9.990009990009992e-4;
//   final constant Integer gas_pT1.gasType.condensingIndex = 1;
//   constant Integer gas_pT1.gasType.ID = 0;
//   Real gas_pT1.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, nominal = 1e5) = 10.0;
...
//   final constant Boolean gas_pT2.gasType.fixedMixingRatio = false;
//   final constant Integer gas_pT2.gasType.nc_propertyCalculation(min = 1) = 1;
//   final constant Integer gas_pT2.gasType.nc = 1;
//   final constant String gas_pT2.gasType.gasNames[1] = "";
//   final constant Real gas_pT2.gasType.mixingRatio_propertyCalculation[1] = 1.0;
//   constant Real gas_pT2.gasType.defaultMixingRatio[1] = 1.0;
//   final constant Integer gas_pT2.gasType.condensingIndex = 0;
//   constant Integer gas_pT2.gasType.ID = 0;
//   Real gas_pT2.p(quantity = "Pressure", unit = "Pa", displayUnit = "bar", min = 0.0, nominal = 1e5) = 10.0;
//   Real gas_pT2.T(quantity = "ThermodynamicTemperature", unit = "K", displayUnit = "degC", min = 0.0, start = 288.15, nominal = 300.0) = 10.0;
// equation
//   gas_pT1.xi = xi1;
//   xi1[1] = 9.990009990009992e-4;
// end TestGas_error;
// endResult
