...
// Result:
// Error processing file: StreamConcept_NoMedium_Total.mo
// Error: Failed to load package StreamConcept_NoMedium_Total (default) using MODELICAPATH /home/omar/.openmodelica/libraries/.
// Error: Class StreamConcept_NoMedium_Total.mo not found in scope <top>.
// Error: Error occurred while flattening model StreamConcept_NoMedium_Total.mo
//
