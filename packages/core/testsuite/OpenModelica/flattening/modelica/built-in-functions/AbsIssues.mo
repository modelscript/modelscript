...
//   assert(abs(Modelica.Math.Vectors.interpolate({0.0, 1.0}, {pressure_drop[1,2], pressure_drop[2,2]}, 0.0, 1)[1]) < 1e-6, "Error: To use TableLookupFlow must specify data that goes through 0,0");
// end AbsIssues;
// endResult
