...
//
// [OpenModelica/flattening/modelica/external-functions/ExternalObjectMod.mo:26:13-26:27:writable] Error: Modified element param not found in class ExtObj$eo.
